...
export default function About() {
    return (
        <div className="w-full h-full bg-yellow-600 ">
            <div className="w-full flex flex-row flex-wrap my-10">
                        ...
                        <div className="flex flex-col md:flex-row gap-6 md:gap-8">
                            ...
                            <div className="flex flex-col text-center md:text-left">
                                ...
                                <div className="flex flex-row gap-4 text-gray-800 my-auto text-2xl mx-auto md:mx-0">
                                    ...
                                    <a className="hover:cursor-pointer hover:text-blue-500" href="https://www.linkedin.com/in/quiahn-ballou/"><Twitter></Twitter></a>
                                </div>
                            </div>
                        </div>
                    </div>
